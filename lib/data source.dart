...
Color primarycolorapp=Color(0xff6ec3bc);

class DataSource {
  static String quotes="Nothing in life is to be feared, it is only to be understood. Now is the time to understand more, so that we may fear less.";
  ...
  static List questionAnswersarabic = [
    {
      "question": "ما هو فيروس كورونا؟",
      "answer":"فيروسات كورونا هي عائلة كبيرة من الفيروسات التي قد تسبب المرض للحيوان أو البشر. ومن المعروف أن العديد من فيروسات كورونا عند البشر تسبب التهابات في الجهاز التنفسي تتراوح من نزلات البرد إلى أمراض أكثر حدة مثل متلازمة الشرق الأوسط التنفسية (ميرس) والجهاز التنفسي الحاد. متلازمة (سارس): أحدث فيروس كورونا تم اكتشافه يسبب مرض فيروس كورونا COVID-19."
      },
    {
       ...
       },
    {
      ...
      "answer":"بينما لا نزال نتعرف على كيفية تأثير COVID-2019 على الأشخاص ، يبدو أن كبار السن والأشخاص الذين يعانون من حالات طبية موجودة مسبقًا (مثل ارتفاع ضغط الدم أو أمراض القلب أو أمراض الرئة أو السرطان أو مرض السكري) يصابون بأمراض خطيرة أكثر من غيرهم."
      },
    {
      "question": "هل يجب أن أرتدي قناعًا لحماية نفسي؟",
      "answer":"ارتدِ قناعًا فقط إذا كنت مريضًا بأعراض COVID-19 (خاصة السعال) أو تعتني بشخص قد يكون مصابًا بـ COVID-19. يمكن استخدام قناع الوجه الذي يمكن التخلص منه مرة واحدة فقط. إذا لم تكن مريضًا أو تعتني بشخص مريض فأنت تهدر قناعًا. يوجد نقص في الأقنعة على مستوى العالم ، لذلك تحث منظمة الصحة العالمية الأشخاص على استخدام الأقنعة بحكمة. \ n تنصح منظمة الصحة العالمية بالاستخدام الرشيد للأقنعة الطبية لتجنب الهدر غير الضروري للموارد الثمينة وسوء استخدام الأقنعة \ n الطرق الأكثر فعالية لحماية نفسك والآخرين ضد COVID-19 هي تنظيف يديك بشكل متكرر ، وتغطية السعال بثني الكوع أو بمنديل ورقي والحفاظ على مسافة لا تقل عن متر واحد (3 أقدام) من الأشخاص الذين يسعلون أو يعطسون"
      },
    {
      "question":
      "هل المضادات الحيوية فعالة في منع أو علاج COVID-19؟",
      "answer":"لا. لا تقضي المضادات الحيوية على الفيروسات ، بل تعمل فقط على الالتهابات البكتيرية. يحدث مرض كوفيد -19 بسبب فيروس ، لذلك لا تعمل المضادات الحيوية. لا ينبغي استخدام المضادات الحيوية كوسيلة للوقاية أو العلاج من COVID-19. يجب استخدامها فقط حسب توجيهات الطبيب لعلاج عدوى بكتيرية."
       }
  ];
}
